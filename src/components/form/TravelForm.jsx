            ...
            <form onSubmit={handleSubmit}>
                  ...
                  {passionOptions.map((passion) => (
                    <Grid item xs={12} sm={6} md={4} key={passion}>
                      <Chip
                        label={passion}
                        clickable
                        variant={formData.passions.includes(passion) ? "filled" : "outlined"}
                        color={formData.passions.includes(passion) ? "primary" : "default"}
              ...
              <Box sx={{ mb: 4 }}>
                <FormControl component="fieldset">
                  ...
                  <RadioGroup
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, specificPlaces: e.target.value }))}
                  >
                    <FormControlLabel
                      value="no"
                      control={<Radio />}
              ...
              {formData.specificPlaces === 'yes' && (
                <Box sx={{ mb: 4 }}>
                  <TextField
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, placesToVisit: e.target.value }))}
                    sx={{ mb: 2 }}
                  />
                </Box>
              )}
              ...
              <Box sx={{ mb: 4 }}>
                <FormControl component="fieldset">
                  ...
                  <RadioGroup
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, accommodationLevel: e.target.value }))}
                  >
                    <FormControlLabel
                      value="mid"
                      control={<Radio />}
              ...
              <Box sx={{ mb: 4 }}>
                <TextField
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, specialServices: e.target.value }))}
